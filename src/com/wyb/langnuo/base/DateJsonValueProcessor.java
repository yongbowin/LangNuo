...
public class DateJsonValueProcessor implements JsonValueProcessor {
	...
	public static final JsonConfig DATECONFIG = new JsonConfig();

	public static void init() throws Exception {
		DATECONFIG.registerJsonValueProcessor(Timestamp.class, new DateJsonValueProcessor("yyyy-MM-dd HH:mm:ss"));
	}
